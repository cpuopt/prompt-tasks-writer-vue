<template>
    <el-popover :visible="visible && panelShow.show" placement="top" :width="280">
        <p>
            你确定要删除<el-text class="mx-1" type="danger"> 任务{{ taskIndex + 1 }} {{ task.title }} </el-text>
            吗？
        </p>
        ...
        <template #reference>
            <el-button class="button-rt" type="danger" size="small" plain @click="visible = true" :icon="Delete" :disabled="disable"></el-button>
        </template>
    </el-popover>
</template>
<script setup>
