<template>
  <div class="button-group" style="padding-inline: 0.2rem">
    ...
    <div v-else style="display: flex; flex-direction: row">
      ...
      <el-button size="small" type="danger" plain @click.stop="preset_load_status = false"
        >取消</el-button
      >
    </div>
  </div>
...
const PRESETS_CHANGE = (value) => {
  ...
  props.container.push(
    PromptsBuilder.addPromptSplice(selectedTagsString(PRESETS_get(value)))
  );
  ElMessage({
    message: `已加载预设 ${value}`,
    type: "success",
