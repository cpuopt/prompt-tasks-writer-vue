                                ...
                                <el-card style="min-width: 600px" body-style="position: relative;">
                                    <template #header>
                                        <div class="card-header" style="">
                                            ...
                                            <el-tooltip class="box-item" effect="dark" content="切换启用/忽略该任务" placement="top-start">
                                                <el-switch
                                                    v-model="task.activate"
                                                    class="mb-2"
                                                    inline-prompt
                                                    style="margin-inline: 0.5rem; margin-left: auto; --el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949; float: inline-end"
                                                    active-text="启用"
                                                    inactive-text="忽略"
                                            ...
                                            <el-tooltip class="box-item" effect="dark" content="复制这一整个任务" placement="top-start">
                                                <el-button
                                                    type="info"
                                                    plain
                                            ...
                                            <div v-show="!(tasklist.tasks.length < 2 || (activateTaskNum < 2 && task.activate == true))" style="margin-inline-start: 0.5rem">
                                                <DeleteTask :task="task" :tasks="tasklist.tasks" :panelShow="panelShow" :taskIndex="taskIndex" />
                                            </div>
                                        </div>
                                    </template>
                                    <div class="button-rt-container">
                                        <el-button size="small" class="button-rt" plain @click="task.fold = !task.fold" :icon="Fold"></el-button>
                                    </div>
                                            ...
                                            <el-card>
                                                <el-form :model="task" label-width="7rem">
                                                    ...
                                                    <el-form-item v-if="task.prompts.splice" label="抽取顺序：">
                                                        <el-tooltip :content="task.prompts.random ? '从每组中随机抽取提示词片段' : '从每组中按顺序选取提示词片段'" placement="right">
                                                            <el-switch
                                                                            ...
                                                                            <TransitionGroup name="list" tag="div" class="prompts">
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <el-input
                                                                                        ...
                                                                                        placeholder="提示词片段"
                                                                                    />
                                                                                    <div v-hide="prompts_group.data.length < 2" class="button-rt-container">
                                                                                        <el-button
                                                                                            type="danger"
                                                                                            size="small"
                                                                                            class="button-rt"
                                    ...
                                    ></el-button> -->
                                                                        ...
                                                                        <el-color-picker size="small" v-model="prompts_group.color" :predefine="predefineColors" @click.stop show-alpha />
                                                                    </div>
                                                                </div>
                                                            </TransitionGroup>
                                                        </VueDraggable>
