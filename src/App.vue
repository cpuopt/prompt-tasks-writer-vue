                                            ...
                                            <el-card style="display: inline-block" shadow="hover">
                                                ...
                                                >
                                                    <TransitionGroup name="list" tag="div" class="charactors">
                                                        <div v-for="(character, index) in task.character.data" class="textarea2button_container" :key="character.uuid" style="position: relative">
                                                            <el-button
                                                                :disabled="!(task.character.data.length > 1)"
                                                                :icon="DCaret"
                                                                class="charactor-prompt-handle cursor-move button-small-square"
                                                                size="small"
                                                            />
                                                            <el-input v-model="character.prompts.data" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea" placeholder="输入角色提示词" />
                                                            <el-input v-model="character.uprompts.data" :autosize="{ minRows: 2, maxRows: 4 }" type="textarea" placeholder="输入角色反向提示词" />
                                                            <div class="button-rt-container">
                                                                <el-button
                                                                    type="danger"
                                                                    size="small"
